				...
				bool assoc_locked)
{
	...
	xassert((assoc_locked && verify_assoc_lock(ASSOC_LOCK, WRITE_LOCK)) ||
		(!assoc_locked && verify_assoc_unlock(ASSOC_LOCK)));
	xassert((assoc_locked && verify_assoc_lock(QOS_LOCK, WRITE_LOCK)) ||
		(!assoc_locked && verify_assoc_unlock(QOS_LOCK)));
	xassert((assoc_locked && verify_assoc_lock(TRES_LOCK, READ_LOCK)) ||
		(!assoc_locked && verify_assoc_unlock(TRES_LOCK)));
